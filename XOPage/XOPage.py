...
class Toplevel1:
    def __init__(self, top=None):
        ...
        XOPage_support.set_button("00", self.Button0)
        ...
        XOPage_support.set_button("01", self.Button1)
        ...
        XOPage_support.set_button("02", self.Button2)
        ...
        XOPage_support.set_button("03", self.Button3)
        ...
        XOPage_support.set_button("04", self.Button4)
        ...
        XOPage_support.set_button("05", self.Button5)
        ...
        XOPage_support.set_button("06", self.Button6)
        ...
        XOPage_support.set_button("07", self.Button7)
        ...
        XOPage_support.set_button("08", self.Button8)
        ...
        self.opponentName_Label.configure(font="-family {Tw Cen MT} -size 9 -weight bold")
        ...
        self.opponentScore_Label.configure(font="-family {Tw Cen MT} -size 9 -weight bold")
        ...
        self.userScore_Label.configure(font="-family {Tw Cen MT} -size 9 -weight bold")

...
def want_to_play(username, game_id, game_number):
    if game_id in want_to_play_dict.keys():
        (username1, game_number1) = want_to_play_dict[game_id]

...
def communication_error():
    global _fe_communication_error
    _fe_communication_error()


def init(fe_communication_error):
    global _fe_communication_error
    _fe_communication_error = fe_communication_error
    return clientComm.init(communication_error)

...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.login.bind('<Button-1>', lambda e: loginPage_support.login(e))
        ...
        self.button_newRegister.configure(command=loginPage_support.startNewRegistrationPage)
        ...
        self.button_forgot.configure(command=loginPage_support.startforgotPage)
